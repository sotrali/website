    ...
    <Layout home={true} id={0}>
      ...
      <div>
        <p>
          ...
          approach my site with a more casual attitude. The styling of the rest
          of my website is the result of me playing with React in this sandbox.
          <br />
          <br />
          ...
          <Link href='projects/'>display my projects</Link>. I developed it even
          further into a hamburger navigation menu that was used for a month or
          two, but I felt that having a simple navbar for my site's main pages
